...
function AddingCards(ArrayFilterBefore){
  let card = ``;
  const BootsCards = document.getElementById("MainCards");
ArrayFilterBefore.forEach((element) => {
    card += `
     <div class="card col">
...
const BootsCardsDos = document.getElementById("MainCardsDos");

function AddingCardsDos(ArrayFilterAfter){
  let card = ``;
  const BootsCardsDos = document.getElementById("MainCardsDos");
...
BootsCardsDos.innerHTML = card
console.log(BootsCardsDos)
};
 
AddingCardsDos(ArrayFilterAfter); 
